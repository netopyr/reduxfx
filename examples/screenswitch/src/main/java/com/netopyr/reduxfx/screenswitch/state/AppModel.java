 ...
 * in the {@link com.netopyr.reduxfx.screenswitch.updater.Updater}. The {@code Updated} gets the current state together with the
 * {@link com.netopyr.reduxfx.screenswitch.actions.Action} that should be performed and calculates the new state from that.
 *
 * The new state is passed to the {@link com.netopyr.reduxfx.screenswitch.view.ViewManager}-function, which calculates the new
 * virtual Scenegraph.
 */
